...
public class YAMLDOrFormula implements YAMLDFormula
{
	private YAMLDFormula op1, op2;

	public YAMLDOrFormula(YAMLDFormula op1, YAMLDFormula op2)
	{
	...
	{
		return op1.toFormattedString() + " OR " + op2.toFormattedString();
	}

	@Override
	public boolean satisfied(State state, YAMLDComponent con) {
		return op1.satisfied(state,con) || op2.satisfied(state,con);
	}
	...
	public YAMLDFormula simplify(Network net) {
		...
		return new YAMLDOrFormula(f1,f2); 
	}
	@Override
	public int hashCode() {
		final int prime = 37;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof YAMLDOrFormula)) {
			return false;
		}
		YAMLDOrFormula other = (YAMLDOrFormula) obj;
		if (op1 == null) {
			if (other.op1 != null) {
				return false;
			}
